...
class TasksFragment : Fragment(), TasksContract.View {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        root.refresh_layout.apply {
            ...
            scrollUpChild = root.tasks_list
            setOnRefreshListener { presenter.loadTasks(false) }
        }
        // Set up tasks view
        filteringLabelView = root.filteringLabel
        tasksView = root.tasksLL

        // Set up  no tasks view
        noTasksView = root.noTasks
        noTaskIcon = root.noTasksIcon
        noTaskMainView = root.noTasksMain
        noTaskAddView = root.noTasksAdd
    ...
    override fun showNoTasks() {
        showNoTasksViews(resources.getString(R.string.no_tasks_all), R.drawable.ic_assignment_turned_in_24dp, true)
    }
