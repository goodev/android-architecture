...
class TasksDaoTest {
    ...
    @Test
    fun insertTaskReplacesOnConflictTest() {
        runBlocking {
            insertTaskReplacesOnConflict()
        }
    }

    suspend fun insertTaskReplacesOnConflict() {
    ...
    @Test
    fun insertTaskAndGetTasksTest() {
        runBlocking { insertTaskAndGetTasks() }
    }

    suspend fun insertTaskAndGetTasks() {
        // When inserting a task
        database.taskDao().insertTask(DEFAULT_TASK)
    ...
    @Test
    fun updateTaskAndGetByIdTest() {
        runBlocking { updateTaskAndGetById() }
    }

    suspend fun updateTaskAndGetById() {
        // When inserting a task
        database.taskDao().insertTask(DEFAULT_TASK)
    ...
    @Test
    fun updateCompletedAndGetByIdTest() {
        runBlocking { updateCompletedAndGetById() }
    }

    suspend fun updateCompletedAndGetById() {
        // When inserting a task
        database.taskDao().insertTask(DEFAULT_TASK)
    ...
    @Test
    fun deleteTaskByIdAndGettingTasksTest() {
        runBlocking { deleteTaskByIdAndGettingTasks() }
    }

    suspend fun deleteTaskByIdAndGettingTasks() {
    ...
    @Test
    fun deleteTasksAndGettingTasksTest() {
        runBlocking { deleteTasksAndGettingTasks() }
    }

    suspend fun deleteTasksAndGettingTasks() {
        // Given a task inserted
        database.taskDao().insertTask(DEFAULT_TASK)
    ...
    @Test
    fun deleteCompletedTasksAndGettingTasksTest() {
        runBlocking { deleteCompletedTasksAndGettingTasks() }
    }

    suspend fun deleteCompletedTasksAndGettingTasks() {
